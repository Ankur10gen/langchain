...
description: Assess LangChain release PR readiness — version consistency, dependency risk on PyPI, public API breaks, and alignment with _release.yml.
...
**Use Claude Sonnet** for this skill (workflow analysis, dependency risk, structured release report).

Not for feature PRs — use `/review-before-pr` (Sonnet/Opus) instead.
